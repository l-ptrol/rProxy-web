...
# VERSION="6.4.6" - Stealth Mode 2.0 (Keenetic Fix)
...
printf "\n${CYAN}==========================================${NC}\n"
printf "${CYAN}    rProxy Python Core v6.4.6             ${NC}\n"
printf "${CYAN}==========================================${NC}\n\n"
...
case "\$1" in
    start)
        echo "Starting rProxy Web v6.4.6..."
        cd "$INSTALL_DIR"
...
msg "Установка rProxy v6.4.6 завершена!"
printf "\n"
