...
# VERSION: 6.2.2 - Modular Architecture (Full Core Parity)
...
printf "\n${CYAN}==========================================${NC}\n"
printf "${CYAN}    rProxy Python Core v6.2.2             ${NC}\n"
printf "${CYAN}==========================================${NC}\n\n"
...
case "\$1" in
    start)
        echo "Starting rProxy Web v6.2.2..."
        cd "$INSTALL_DIR"
...
msg "Установка rProxy v6.2.2 завершена!"
printf "\n"
