...
# VERSION="6.4.1" - Certbot Fix & Stability
...
printf "\n${CYAN}==========================================${NC}\n"
printf "${CYAN}    rProxy Python Core v6.4.1             ${NC}\n"
printf "${CYAN}==========================================${NC}\n\n"
...
case "\$1" in
    start)
        echo "Starting rProxy Web v6.4.1..."
        cd "$INSTALL_DIR"
...
msg "Установка rProxy v6.4.1 завершена!"
printf "\n"
