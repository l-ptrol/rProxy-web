...
printf "\n${CYAN}==========================================${NC}\n"
printf "${CYAN}    rProxy Python Core v6.6.8             ${NC}\n"
printf "${CYAN}==========================================${NC}\n\n"
...
opkg update
opkg install python3 python3-pip autossh psmisc openssh-keygen openssl-util ttyd
...
case "\$1" in
    start)
        echo "Starting rProxy Web v6.6.8..."
        cd "$INSTALL_DIR"
...
msg "Установка rProxy v6.6.8 успешно завершена!"
printf "\n"
