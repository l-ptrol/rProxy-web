...
printf "\n${CYAN}==========================================${NC}\n"
printf "${CYAN}    rProxy Python Core v6.6.0             ${NC}\n"
printf "${CYAN}==========================================${NC}\n\n"
...
case "\$1" in
    start)
        echo "Starting rProxy Web v6.6.0..."
        cd "$INSTALL_DIR"
...
msg "Установка rProxy v6.6.0 успешно завершена!"
printf "\n"
