...
# VERSION="6.3.3" - Modular Architecture (Full Core Parity)
...
printf "\n${CYAN}==========================================${NC}\n"
printf "${CYAN}    rProxy Python Core v6.3.3             ${NC}\n"
printf "${CYAN}==========================================${NC}\n\n"
...
case "\$1" in
    start)
        echo "Starting rProxy Web v6.3.3..."
        cd "$INSTALL_DIR"
...
msg "Установка rProxy v6.3.3 завершена!"
printf "\n"
